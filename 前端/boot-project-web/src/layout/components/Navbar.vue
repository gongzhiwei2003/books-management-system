    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown" class="user-dropdown">
          <router-link to="/">
            <el-dropdown-item style="font-size: 15px;color: black"> 首页</el-dropdown-item>
          </router-link>
          <el-dropdown-item divided @click.native="updatePwd">
            <span style="display: block;font-size: 15px;color: black">修改密码</span>
          </el-dropdown-item>
          <el-dropdown-item divided @click.native="logout">
            <span style="display: block;font-size: 15px;color: black">退出登录</span>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
