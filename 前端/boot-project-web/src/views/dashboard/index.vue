<template>
  <el-main>
    ...
    >
        ...
        <el-col :span="6">
          <div class="show-header" style="background: rgb(34,214,47)">
    ...
    <el-card class="box-card" style="margin-top: 30px ;background-color: #58e573">
      <div slot="header" class="clearfix" >
        <span style="color: #000000; font-size: 18px; font-weight: 600">公告列表</span>
      </div>
