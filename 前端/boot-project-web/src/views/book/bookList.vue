<template>
  <el-main>
    ...
    <el-form :model="listParm" :inline="true" size="small">
      <el-form-item>
        <el-select v-model="listParm.categoryId" placeholder="请选择图书类别">
          <el-option
    ...
    <el-table :height="tableHeight" :data="tableData"
              :header-row-style="{fontSize: '20px',fontWeight: 'bold',color:'#333'}"
              :cell-style="{color: '#606266',fontSize: '15px'}"
              border stripe>
